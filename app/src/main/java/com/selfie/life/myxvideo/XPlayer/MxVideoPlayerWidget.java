package com.selfie.life.myxvideo.XPlayer;
...
import com.selfie.life.myxvideo.R;
...
public class MxVideoPlayerWidget extends MxVideoPlayer {
    ...
    private static final String TAG = MxVideoPlayerWidget.class.getSimpleName();
    ...
    MxVideoPlayerWidgetListener listener;
    ...
    public boolean autoStartPlay(String url, int screen,MxVideoPlayerWidgetListener listener,Object... objects) {
    ...
    private void changeUiShowState(Mode mode) {
        ...
        switch (mode) {
            case MODE_NORMAL:
                setAllControlsVisible(View.VISIBLE, View.INVISIBLE, View.VISIBLE,View.INVISIBLE, View.VISIBLE, View.INVISIBLE);
            ...
            case MODE_PREPARING:
                ...
                //setAllControlsVisible(View.INVISIBLE, View.INVISIBLE, View.INVISIBLE,View.VISIBLE, View.VISIBLE, View.INVISIBLE);
                break;
            ...
            case MODE_COMPLETE_CLEAR:
                setAllControlsVisible(View.INVISIBLE, View.INVISIBLE, View.VISIBLE,View.INVISIBLE, View.VISIBLE, View.VISIBLE);
                updateStartImage();
                break;
            case MODE_ERROR:
                setAllControlsVisible(View.INVISIBLE, View.INVISIBLE, View.VISIBLE,View.INVISIBLE, View.INVISIBLE, View.INVISIBLE);
    ...
    public interface MxVideoPlayerWidgetListener {
