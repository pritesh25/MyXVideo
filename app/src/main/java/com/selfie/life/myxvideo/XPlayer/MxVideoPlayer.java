...
import static com.selfie.life.myxvideo.XPlayer.MxUtils.scanForActivity;
...
public abstract class MxVideoPlayer extends FrameLayout implements MxMediaPlayerListener, View.OnClickListener,
    ...
    private static final String TAG = "MxVideoPlayer";
    ...
    private void setTextAndProgress(int secProgress) {
        ...
        Log.d(TAG,"(setTextAndProgress) progress = "+progress);
